...
begin;
	insert into setor values ( 5, 'Calibragem');
...
-- teste de rollback : execute o begin ate o ultimo update, deixando o end de fora. Depois execute o select de cliente 
-- e depois gere o erro do segundo select. Apos isso execute o end, terminando a transação, e execute o select de cliente.
select * from cliente
select * from mecanico where nome = 123
...
-- teste
k = 0
select * from setor join mecanico using(cods)
